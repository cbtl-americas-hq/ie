...
map.getView().fit([-13150402.154833, 3963743.670865, -12912380.501257, 4127103.184588], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Inland Empire Target Trade Areas</h2>';
        return titleElement;
    })(),
